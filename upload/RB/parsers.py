...
COL_ENDERECO_NUMERO = slice(91, 103)
COL_ENDERECO_COMPLEMENTO = slice(104, 130)
...
COL_FUNCIONARIO_FUNCAO = slice(132, 147)
COL_FUNCIONARIO_DATA_NASC = slice(172, 180)
COL_FUNCIONARIO_CPF = slice(183, 194)
COL_FUNCIONARIO_CEP = slice(250,258)
COL_FUNCIONARIO_RUA = slice(258,310)
COL_FUNCIONARIO_NUMERO = slice(316,325)
COL_FUNCIONARIO_BAIRRO = slice(358, 390)
COL_FUNCIONARIO_CIDADE = slice(398, 430)
COL_FUNCIONARIO_ESTADO = slice(438, 440)




COL_BENEFICIO_MATRICULA = slice(19, 32)
COL_BENEFICIO_NUM_DIAS = slice(105, 108)
COL_BENEFICIO_VALOR = slice(109, 116)
COL_BENEFICIO_PRODUTO = slice(44, 88)
COL_CODIGO_PRODUTO = slice(39, 44)
